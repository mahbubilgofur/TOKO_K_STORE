    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="<?= base_url() ?>dasboard/img/payments.png" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
    ...
    <script src="<?= base_url() ?>dasboard/mail/jqBootstrapValidation.min.js"></script>
    <script src="<?= base_url() ?>dasboard/mail/contact.js"></script>
