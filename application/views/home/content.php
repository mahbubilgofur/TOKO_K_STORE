...
<style>
        ...
        #mySlider {
            margin-top: 0; /* Menghapus margin atas pada slider */
        }

        .navbar {
            margin-bottom: 0; /* Menghapus margin bawah pada navbar */
        }
...
.kategori-wrapper:hover p {
  ...
  .kategori-wrapper img {
    width: 100%; /* Sesuaikan lebar gambar dengan kebutuhan */
  }
...
.kategori-wrapper:hover::before {
    ...
    font-size: 18px; /* Ukuran teks pada hover */
    font-weight: bold; /* Ketebalan teks pada hover */
  }
.kategori img {
  width: 50px;
  height: 50px;
...
<div class="containerku">
    ...
    <div class="kategori-wrapper">
      <div class="kategori">
      <a href="<?= base_url('pakaian pria')?>">
        <img src="<?= base_url()?>assets/imgkategori/bajupria.png" alt="Electronics">
        <p>Pakaian Pria</p>
        </a>
      </div>
    </div>
    <div class="kategori-wrapper">
      <div class="kategori">
         <a href="">
        <img src="<?= base_url()?>assets/imgkategori/celana.png" alt="Electronics">
        <p>Celana</p>
        </a>
      </div>
    </div>
    <div class="kategori-wrapper">
      <div class="kategori">
         <a href="">
        <img src="<?= base_url()?>assets/imgkategori/bajuwanita.png" alt="Fashion">
        <p>Pakaian Wanita</p>
        </a>
      </div>
    </div>
    <div class="kategori-wrapper">
      <div class="kategori">
         <a href="">
        <img src="<?= base_url()?>assets/imgkategori/sepatu.png" alt="Home">
        <p>Sepatu</p>
        </a>
      </div>
    </div>
    <div class="kategori-wrapper">
      <div class="kategori">
         <a href="<?= base_url('home/search?keyword=topi')?>">
        <img src="<?= base_url()?>assets/imgkategori/topi.jpeg" alt="Home">
        <p>Topi</p>
        </a>
      </div>
    </div>
