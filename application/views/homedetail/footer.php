                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        <div class="product-details-left">
                            <div class="product-details-images slider-navigation-1">
                                <div class="lg-image">
                                    <img src="<?= base_url() ?>template/images/product/large-size/1.jpg" alt="product image">
                                </div>
                                <div class="lg-image">
                                    <img src="<?= base_url() ?>template/images/product/large-size/2.jpg" alt="product image">
                                </div>
                                <div class="lg-image">
                                    <img src="<?= base_url() ?>template/images/product/large-size/3.jpg" alt="product image">
                                </div>
                                <div class="lg-image">
                                    <img src="<?= base_url() ?>template/images/product/large-size/4.jpg" alt="product image">
                                </div>
                                <div class="lg-image">
                                    <img src="<?= base_url() ?>template/images/product/large-size/5.jpg" alt="product image">
                                </div>
                                <div class="lg-image">
                                    <img src="<?= base_url() ?>template/images/product/large-size/6.jpg" alt="product image">
                                </div>
                            </div>
                            <div class="product-details-thumbs slider-thumbs-1">
                                <div class="sm-image"><img src="<?= base_url() ?>template/images/product/small-size/1.jpg" alt="product image thumb"></div>
                                <div class="sm-image"><img src="<?= base_url() ?>template/images/product/small-size/2.jpg" alt="product image thumb"></div>
                                <div class="sm-image"><img src="<?= base_url() ?>template/images/product/small-size/3.jpg" alt="product image thumb"></div>
                                <div class="sm-image"><img src="<?= base_url() ?>template/images/product/small-size/4.jpg" alt="product image thumb"></div>
                                <div class="sm-image"><img src="<?= base_url() ?>template/images/product/small-size/5.jpg" alt="product image thumb"></div>
                                <div class="sm-image"><img src="<?= base_url() ?>template/images/product/small-size/6.jpg" alt="product image thumb"></div>
                            </div>
                        </div>
                        <!--// Product Details Left -->
                    </div>
...
<!-- Ajax Mail js -->
<script src="<?= base_url() ?>template/js/ajax-mail.js"></script>
<!-- Meanmenu js -->
<script src="<?= base_url() ?>template/js/jquery.meanmenu.min.js"></script>
<!-- Wow.min js -->
...
<!-- Mixitup js -->
<script src="<?= base_url() ?>template/js/jquery.mixitup.min.js"></script>
<!-- Countdown -->
<script src="<?= base_url() ?>template/js/jquery.countdown.min.js"></script>
<!-- Counterup -->
<script src="<?= base_url() ?>template/js/jquery.counterup.min.js"></script>
<!-- Waypoints -->
<script src="<?= base_url() ?>template/js/waypoints.min.js"></script>
<!-- Barrating -->
<script src="<?= base_url() ?>template/js/jquery.barrating.min.js"></script>
<!-- Jquery-ui -->
<script src="<?= base_url() ?>template/js/jquery-ui.min.js"></script>
<!-- Venobox -->
<script src="<?= base_url() ?>template/js/venobox.min.js"></script>
<!-- Nice Select js -->
<script src="<?= base_url() ?>template/js/jquery.nice-select.min.js"></script>
<!-- ScrollUp js -->
<script src="<?= base_url() ?>template/js/scrollUp.min.js"></script>
<!-- Main/Activator js -->
<script src="<?= base_url() ?>template/js/main.js"></script>
<script src="<?= base_url() ?>layout/plugins/sweetalert2/sweetalert2.min.js"></script>
<!-- Toastr -->
<script src="<?= base_url() ?>layout/plugins/toastr/toastr.min.js"></script>

<script>
    document.addEventListener("DOMContentLoaded", function() {
        var searchInput = document.getElementById("search-input");
        var provinsiList = document.getElementById("provinsi-list");
        var provinsiItems = provinsiList.querySelectorAll("li");

        searchInput.addEventListener("input", function() {
            var searchTerm = searchInput.value.toLowerCase();

            for (var i = 0; i < provinsiItems.length; i++) {
                var provinsiName = provinsiItems[i].innerText.toLowerCase();
                if (provinsiName.indexOf(searchTerm) > -1) {
                    provinsiItems[i].style.display = "";
                } else {
                    provinsiItems[i].style.display = "none";
                }
            }

            // Menampilkan atau menyembunyikan daftar berdasarkan hasil pencarian
            var isAnyVisible = Array.from(provinsiItems).some(item => item.style.display !== 'none');
            provinsiList.style.display = isAnyVisible ? "block" : "none";
        });

        // Menyembunyikan daftar saat input dikosongkan
