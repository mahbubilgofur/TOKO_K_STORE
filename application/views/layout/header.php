...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>layout/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>layout/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    <!-- Theme style -->
