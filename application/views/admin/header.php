...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>layout/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet" href="<?= base_url() ?>layout/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    <link rel="stylesheet" href="<?= base_url() ?>layout/plugins/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?= base_url() ?>layout/plugins/summernote/summernote-bs4.min.css">
</head>